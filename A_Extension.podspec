...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/ModulizationDemo/A_Extension"
  ...
  s.source       = { :git => "https://github.com/ModulizationDemo/A_Extension.git", :tag => s.version.to_s }
  ...
  s.source_files  = "A_Extension/A_Extension/**/*.{h,m,swift}"
